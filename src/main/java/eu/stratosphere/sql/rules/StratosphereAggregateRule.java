...
public class StratosphereAggregateRule extends ConverterRule {
	...
	public RelNode convert(RelNode rel) {
		...
		return new StratosphereSqlAggregation(aggregate.getCluster(), traits, convert(aggregate.getChild(), aggregate.getChild().getTraitSet().plus(StratosphereRel.CONVENTION)), aggregate.getGroupSet(), aggregate.getAggCallList());
	}
